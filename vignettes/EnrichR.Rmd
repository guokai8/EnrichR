...
```{r,fig.height=6,fig.width=6,fig.align="center",dpi=500,fig.cap="Gene ontology enrichment analysis results"}
...
```     
```{r,fig.height=6,fig.width=6,fig.align="center",dpi=500,fig.cap="KEGG pathway enrichment analysis results"}  
